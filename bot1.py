...
def keyboard_opener(bot, update):
    reply_markup =  button_list = [InlineKeyboardButton('Кукуруза', callback_data = '1'),
                                   InlineKeyboardButton('Горошек', callback_data = '2'),
                                   InlineKeyboardButton('Оливки зеленые', callback_data = '3'),
                                   InlineKeyboardButton('Оливки черные', callback_data = '4'),
                                   InlineKeyboardButton('Макароны Макфа', callback_data = '5'),
                                   InlineKeyboardButton('Спагетти Макфа', callback_data = '6'),
                                   InlineKeyboardButton('Сок яблочный', callback_data = '7'),
                                   InlineKeyboardButton('Сок гранатовый', callback_data = '8'),
                                   ]
    reply_markup = InlineKeyboardMarkup(build_menu(button_list, n_cols=len(button_list)))
